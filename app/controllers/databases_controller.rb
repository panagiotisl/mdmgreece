class DatabasesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @database.save
        format.html { redirect_to @database, notice: 'Term Database was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @database.update(database_params)
        format.html { redirect_to @database, notice: 'Term Database was successfully updated.' }
  ...
  def destroy
    @database.destroy
    respond_to do |format|
      format.html { redirect_to databases_url, notice: 'Term Database was successfully destroyed.' }
